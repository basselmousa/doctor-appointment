            ...
            <div class="row flex-grow ">
                <div class="col-lg-12 d-flex align-items-center justify-content-center">
                    <div class="auth-form-transparent text-left p-3">
                        ...
                        <form class="pt-3" action="{{ route('admin.edit.put') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                           value="{{ auth('admin')->user()->full_name }}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="days[]"   class="js-example-basic-multiple w-100 @error('days') is-invalid @enderror" multiple id="exampleFormControlSelect2">
                                    <option {{ $days->contains( 'sunday') ? 'selected' : '' }} value="sunday">Sunday</option>
                                    <option {{ $days->contains( 'monday') ? 'selected' : '' }} value="monday">Monday</option>
                                    <option {{ $days->contains( 'tuesday') ? 'selected' : '' }} value="tuesday">Tuesday</option>
                                    <option {{ $days->contains( 'wednesday') ? 'selected' : '' }} value="wednesday">Wednesday</option>
                                    <option {{ $days->contains( 'thursday') ? 'selected' : '' }} value="thursday">Thursday</option>
                                    <option {{ $days->contains( 'friday') ? 'selected' : '' }} value="friday">Friday</option>
                                    <option {{ $days->contains( 'saturday') ? 'selected' : '' }} value="saturday">Saturday</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="certificates" class="form-control form-control-lg @error('certificates') is-invalid @enderror"  id="exampleInputPassword" >{{ auth('admin')->user()->certificates }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ auth('admin')->user()->phone_number }}" name="phone_number" class="form-control form-control-lg @error('phone_number') is-invalid @enderror" id="exampleInputPassword" placeholder="009627********">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="time" name="start" value="{{ auth('admin')->user()->start }}" class="form-control form-control-lg @error('start') is-invalid @enderror" id="exampleInputPassword" placeholder="Password">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="time" name="end" value="{{ auth('admin')->user()->end }}" class="form-control form-control-lg @error('end') is-invalid @enderror" id="exampleInputPassword" placeholder="Password">
